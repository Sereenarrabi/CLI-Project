...
const palindrome = require("./Commands/Palindrome-command");
const lower= require("./Commands/lower-command");
const digits = require("./Commands/digits-command");
const armstrong = require("./Commands/ArmStrong-command");
const exit = require("./Commands/Exit-command");
const nationalize = require("./Commands/Nationalize-command");
exports.rl = readline.createInterface({
    input: process.stdin,
    output: process.stdout,
});
const commands = [new palindrome.PalindromeCommand(), new lower.LowerCommand(), new digits.DigitsCommand(), new armstrong.ArmstrongCommand(), new nationalize.NationalizeCommand(), new exit_command_1.ExitCommand()];
